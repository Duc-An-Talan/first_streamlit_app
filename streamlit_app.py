...
#create a function 
def get_fruityvice_data(this_choice_fruit):
      fruityvice_response = requests.get("https://fruityvice.com/api/fruit/"+this_choice_fruit)
...
streamlit.title("View Our Fruit List - Add Your Favorite")
